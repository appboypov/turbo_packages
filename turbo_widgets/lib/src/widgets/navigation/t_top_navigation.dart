...
/// A horizontal navigation bar intended for top placement.
///
/// Renders navigation buttons using a [Flex] layout.
/// Works seamlessly with [TContextualButtons] when placed in the top slot.
class TTopNavigation extends StatelessWidget {
  const TTopNavigation({
