...
/// A vertical navigation bar intended for side placement.
///
/// Renders navigation buttons using a [Flex] layout.
/// Works seamlessly with [TContextualButtons] when placed in the left or right slot.
class TSideNavigation extends StatelessWidget {
  const TSideNavigation({
...
class _TSideNavigationButton extends StatelessWidget {
  const _TSideNavigationButton({
