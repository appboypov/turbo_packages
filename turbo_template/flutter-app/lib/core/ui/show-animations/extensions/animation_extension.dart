...
extension AnimationExtension on Widget {
  Widget slideBottomUp({
    ...
    double? target,
      ...
      RepaintBoundary(child: this).animate(target: target).slideY(
            curve: curve,
            begin: begin,
            end: 0,
            duration: duration,
  ...
  Widget fadeWithoutRepaint({
    ...
    Curve curve = Curves.linear,
      ...
      animate(target: target, autoPlay: autoPlay, key: key).fade(
        duration: duration,
        delay: delay,
        curve: curve,
      );
    ...
    double? target,
      ...
      RepaintBoundary(child: this)
          ...
          .slideX(
            ...
            duration: duration + (slideInDelay ?? Duration.zero),
          )
          .fadeIn()
          .then()
          .slideX(
