...
/// A helper widget that measures its child's size.
...
class TButtonRaw extends StatefulWidget {
  const TButtonRaw({
    super.key,
    this.child,
...
class _TButtonRawState extends State<TButtonRaw> with SingleTickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(covariant TButtonRaw oldWidget) {
    ...
    child: Listener(
      ...
      child: TConstraints(
        ...
        child: GestureDetector(
          ...
          onTapUp: (_) => widget.onPressed?.call(),
        ),
      ),
    ),
  );
