...
class TGap extends Gap {
  ...
  const TGap.inlineText({super.key, double multiplier = 1})
    : super(TSizes.textGap * multiplier);
  const TGap.label({super.key, double multiplier = 1})
    : super(TSizes.itemGap * multiplier);
  const TGap.listItem({super.key, double multiplier = 1})
    : super(TSizes.listItemGap * multiplier);
  const TGap.scaffoldTitle({super.key, double multiplier = 1})
    : super(TSizes.titleGap * multiplier);
  const TGap.section({super.key, double multiplier = 1})
    : super(TSizes.sectionGap * multiplier);
